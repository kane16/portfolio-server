...
class ValidationMapper {
  ...
  fun mapResumeValidationResultToDTO(validationResult: ResumeValidatorResult): ValidationResultDTO {
    val domainResults: List<ValidationDomainResultDTO> =
      validationResult.domainResults.map { domainResult ->
    ...
    return ValidationResultDTO(
      ...
      domainResults.filter { it.validationStatus == ValidationStatus.VALID }
        .sumOf { it.domain.weight },
      domainResults
    )
  }

  fun mapValidationResultToDTO(
